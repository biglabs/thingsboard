 ...
 */
package com.biglabs.iot.tsexportservice.security.auth.jwt.extractor;

import org.apache.commons.lang3.StringUtils;
import org.springframework.security.authentication.AuthenticationServiceException;
import org.springframework.stereotype.Component;
import com.biglabs.iot.tsexportservice.config.TsExportSecurityConfiguration;
...
public class JwtQueryTokenExtractor implements TokenExtractor {
    ...
    public String extract(HttpServletRequest request) {
        ...
        if (request.getParameterMap() != null && !request.getParameterMap().isEmpty()) {
            String[] tokenParamValue = request.getParameterMap().get(TsExportSecurityConfiguration.JWT_TOKEN_QUERY_PARAM);
