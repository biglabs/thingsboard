 ...
 */
package com.biglabs.iot.tsexportservice.config;

import com.biglabs.iot.tsexportservice.security.auth.jwt.*;
...
import com.biglabs.iot.tsexportservice.security.auth.rest.RestAuthenticationProvider;
import com.biglabs.iot.tsexportservice.security.auth.rest.RestLoginProcessingFilter;
import com.biglabs.iot.tsexportservice.security.auth.jwt.extractor.TokenExtractor;
import com.biglabs.iot.tsexportservice.security.auth.rest.RestPublicLoginProcessingFilter;
...
public class TsExportSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    @Autowired private TsExportErrorResponseHandler restAccessDeniedHandler;
