...
public class RestAwareAuthenticationFailureHandler implements AuthenticationFailureHandler {
    ...
    private final TsExportErrorResponseHandler errorResponseHandler;

    @Autowired
    public RestAwareAuthenticationFailureHandler(TsExportErrorResponseHandler errorResponseHandler) {
